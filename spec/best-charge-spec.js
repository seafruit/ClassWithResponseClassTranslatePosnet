...
let DigitalTranslator = require('../src/best-charge');
let allCharge = new DigitalTranslator();
describe('Take out food', function () {
  ...
  it('tanslateBarcode',function(){
    let input='|:::||::|:|::||::|::|:|:|::|:|:|';
    // let result=allCharge.outfunction();
  ...
  it('tanslateBarcode',function(){
    let input='|:::||::|:|::||::|::|:|:sddcws';
    let result= allCharge.tanslateBarcode(input);
    // let result= allCharge.outfunction(input);
